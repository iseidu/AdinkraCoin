#!/usr/bin/env python3
# Copyright (c) 2016-2019 The Adinkracoin Core developers
...
libs = [
    'libadinkracoin_cli',
    'libadinkracoin_common',
    'libadinkracoin_crypto',
    'libadinkracoin_server',
    'libadinkracoin_util',
    'libadinkracoin_wallet_tool',
    'libadinkracoin_wallet',
    'libadinkracoin_zmq',
    'bench_adinkracoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Adinkracoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/adinkracoin_config.h'), os.path.join(SOURCE_DIR, 'config/adinkracoin-config.h'))
