...
// adinkracoin includes.
#include <..\src\script\adinkracoinconsensus.h>
...
int main()
{
    std::cout << "adinkracoinconsensus version: " << adinkracoinconsensus_version() << std::endl;
    ...
    adinkracoinconsensus_error err;
    auto op0Result = adinkracoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, adinkracoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
