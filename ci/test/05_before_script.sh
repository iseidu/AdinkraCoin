...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Adinkracoin
else
  DOCKER_EXEC echo \> \$HOME/.adinkracoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/adinkracoin/adinkracoin/pull/18288#discussion_r433189350 for
  # details.
