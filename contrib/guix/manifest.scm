...
(define* (make-adinkracoin-cross-toolchain target
                                       #:key
...
desirable for building Adinkracoin Core release binaries."
...
(define glibc-2.27/adinkracoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-adinkracoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/adinkracoin-patched
