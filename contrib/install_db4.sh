#!/bin/sh
# Copyright (c) 2017-2019 The Adinkracoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the adinkracoin repository."
  exit 1
fi
...
# See https://github.com/adinkracoin/adinkracoin/issues/16064
...
echo 'When compiling adinkracoind, run `./configure` in the following way:'
echo
