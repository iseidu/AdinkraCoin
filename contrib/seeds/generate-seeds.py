#!/usr/bin/env python3
# Copyright (c) 2014-2021 The Adinkracoin Core developers
...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ADINKRACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define ADINKRACOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the adinkracoin network\n')
    ...
    g.write('#endif // ADINKRACOIN_CHAINPARAMSSEEDS_H\n')
