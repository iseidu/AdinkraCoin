...
"""Script for verifying Adinkracoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
adinkracoincore.org and adinkracoin.org and compares them.
...
WORKINGDIR = "/tmp/adinkracoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://adinkracoincore.org"
HOST2 = "https://adinkracoin.org"
VERSIONPREFIX = "adinkracoin-core-"
...
def main(args):
    ...
    if not success:
        print("adinkracoin.org failed to provide signature file, "
              "but adinkracoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("adinkracoin.org and adinkracoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Adinkracoin Core binary release "
